...
CREATE TABLE Oferta (
  ...
  data_de_publicacao INTEGER NOT NULL DEFAULT (strftime('%s', 'now')) CONSTRAINT oferta_data_nao_futura CHECK (data_de_publicacao <= strftime('%s')),
...
CREATE TABLE Mensagem (
  ...
  data_de_envio INTEGER NOT NULL DEFAULT (strftime('%s', 'now')) CONSTRAINT mensagem_data_nao_futura CHECK (data_de_envio <= strftime('%s')),
...
CREATE TABLE Compra (
  ...
  oferta INTEGER NOT NULL REFERENCES Oferta
    ON UPDATE CASCADE,
  data_da_compra INTEGER NOT NULL DEFAULT (strftime('%s', 'now')) CONSTRAINT compra_data_nao_futura CHECK (data_da_compra <= strftime('%s')),
